...
def get_repository_price (
    ...
    collection_history: Annotated[AsyncIOMotorCollection, Depends(get_history_price_collection)],
) -> PriceRepository:
    return PriceRepository(collection=collection, collection_history= collection_history)
