...
class AuthService:
    ...
    async def create_access_token(self, user: UserBase, mfa_verified: bool = False) -> str:
    ...
    async def verify_and_enable_mfa(self, username: str, secret: str, code: str) -> bool:
